...
struct RandomQuote: View {
    ...
    for any reason, no matter what, no matter where, or
    who you are with, or or where you are going, or where you've
    been, ever, for any reason, whatsoever. - Michael Scott
    """,
    """
    ...
    """
    You've sacrificed your entire life to be who you are today.
    ...
    """,
    """
    Don't worry that you aren't giving people what they want.
    Give them who you are, and let that be enough.
    - Brandon Sanderson
    """,
