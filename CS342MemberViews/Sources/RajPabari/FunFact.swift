...
struct FunFact: View {
    ...
    let facts = [
    "",
    "Fun Fact 1: Raj has given a TEDx Talk on The Renaissance of Capitalism",
    "Fun Fact 2: Raj finished a marathon in 4 hours",
    "Fun Fact 3: Raj founded Off Grid Technologies, Inc. where he created portable hydro generators to charge mobile devices",
    ...
    var body: some View {
        ...
        Button {
            randomInt = Int.random(in: 1..<facts.count)
        } label: {
